...
import parentClasses from '../../layout/Header/index.module.css';
import siteBarClasses from '../../layout/SiteBar/index.module.css';
...
const Search: React.FC = () => {
    ...
    return (
        <div className={classNames(
            ...
            parentClasses.searchHeader,
            siteBarClasses.searchSiteBar
        )}>
            ...
            <div className={classes.seaech} onClick={toogleIsOpen}>
                { isLoading ? <Loading type='roundSmall' /> : (
