...
const HelpSection: React.FC = () => {
    ...
    const descriptionTextes = [
        'With our simple steps, you can get a free truck insurance quote at Los Angeles Truck Insurance!',
        'Your reliable and trusted commercial trucking insurance agency.',
