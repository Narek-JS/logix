                        ...
                        <div key={index} className={classes.vehicleList}>
                            <div className={classes.inputWrapper}>
                                <input
                                    ...
                                    value={vehicle.year}
                                />
                                { errors?.vehicle?.[index]?.year && <span className={classes.error}>{errors.vehicle?.[index]?.year}</span>}
                            </div>
                            <div className={classes.inputWrapper}>
                                <input
                                    className={classes.input}
                                    ...
                                    value={vehicle.make}
                                />
                                { errors?.vehicle?.[index]?.make && <span className={classes.error}>{errors.vehicle?.[index]?.make}</span>}
                            </div>
                            <div className={classes.inputWrapper}>
                                <input
                                    className={classes.input}
                                    ...
                                    value={vehicle.model}
                                />
                                { errors?.vehicle?.[index]?.model && <span className={classes.error}>{errors.vehicle?.[index]?.model}</span>}
                            </div>
                        </div>
                    )
                })}
